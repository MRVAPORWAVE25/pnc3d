 ...
 * @default Default Movement Layout
 *
 * @param WASD Help
 * @parent ---Help Text---
 * @desc This is the help message that will display for WASD.
 * @default Changes your keyboard to the Default Movement Layout.
 *
 * @param Finish Config
 * @parent ---Help Text---
 ...
 * @param Q Key
 * @parent ---Key Names---
 * @desc This is the Q action will appear on a key.
 * @default RotLeft
 *
 * @param Q Text
 * @parent ---Key Names---
 * @desc This is the Q action will appear for the config text.
 * @default RotLeft
 *
 * @param E Key
 * @parent ---Key Names---
 * @desc This is the E action will appear on a key.
 * @default RotRight
 *
 * @param E Text
 * @parent ---Key Names---
 * @desc This is the E action will appear for the config text.
 * @default RotRight
 *
 * @help
 * ============================================================================
...
Yanfly.Param.KeyConfigQKey = String(Yanfly.Parameters['Q Key']);
Yanfly.Param.KeyConfigQTx = String(Yanfly.Parameters['Q Text']);
Yanfly.Param.KeyConfigEKey = String(Yanfly.Parameters['E Key']);
Yanfly.Param.KeyConfigETx = String(Yanfly.Parameters['E Text']);
...
ConfigManager.defaultMap = {
  ...
  37: 'left', 38: 'up', 39: 'right', 40: 'down', 90: 'ok', 
  88: 'cancel', 98: 'down', 100: 'left', 45: 'cancel', 96: 'cancel', 27: 'escape',
  102: 'right', 104: 'up', 120: 'debug', 81: 'q', 69: 'e'
};
...
Yanfly.KeyConfig.Window_Options_cursorRight =
  Window_Options.prototype.cursorRight;
Window_Options.prototype.cursorRight = function() {
  if (this.commandSymbol(this.index()) === 'keyConfig') {
    Window_Command.prototype.processOk.call(this);
  } else {
    Yanfly.KeyConfig.Window_Options_cursorRight.call(this);
  }
};

Yanfly.KeyConfig.Window_Options_cursorLeft =
  Window_Options.prototype.cursorLeft;
Window_Options.prototype.cursorLeft = function() {
  if (this.commandSymbol(this.index()) === 'keyConfig') {
    Window_Command.prototype.processOk.call(this);
  } else {
    Yanfly.KeyConfig.Window_Options_cursorLeft.call(this);
  }
};
...
Window_KeyConfig.prototype.actionKey = function(action) {
		...
		case 'down':
			...
			break;
	    case 'q':
		      return Yanfly.Param.KeyConfigQKey;
		      break;
	    case 'e':
		      return Yanfly.Param.KeyConfigEKey;
		      break;
	    default:
	      if (Imported.YEP_ButtonCommonEvents) {
...
Window_KeyAction.prototype.makeCommandList = function() {
  ...
  this.addCommand(Yanfly.Param.KeyConfigQTx, 'ok', true, 'q');
  this.addCommand(Yanfly.Param.KeyConfigETx, 'ok', true, 'e');
